...
public interface BookingRepository extends JpaRepository<Booking, Long> {
    ...
    List<Object[]> CheckMultipleAvailabilityInTimeFrame3(
            @Param("input_category_name") String input_category_name,
            @Param("input_category_type") String input_category_type,   // CSV, lowercase, no spaces
            @Param("input_category_fuel") String input_category_fuel,   // CSV, lowercase, no spaces
            @Param("input_category_automatic") Boolean input_category_automatic,
            @Param("input_num_of_seats") String input_num_of_seats,     // CSV digits
